defmodule FastllmcppWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(FastllmcppWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(FastllmcppWeb.Gettext, "errors", msg, opts)
    end
  end
